...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://backend.e-clinic.ai/api/v1/accounts/login/', {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.message || errorData.email || 'Something went wrong. Please try again');
